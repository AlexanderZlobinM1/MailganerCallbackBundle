...
copy_file "Model/DncFeedback.php"
copy_file "Model/SharedSettings.php"
copy_file "EventSubscriber/SettingsLifecycleSubscriber.php"
copy_file "Resources/views/Integration/settings-state.js.twig"
copy_file "Tests/Functional/CallbackSubscriberTest.php"
copy_file "Translations/en_US/messages.ini"
copy_file "Translations/ru/messages.ini"
copy_file "Translations/ru_RU/messages.ini"
copy_file "Translations/sr_RS/messages.ini"
cp "$LITE_DIR/Integration/MailganerIntegration.php" "$FULL_DIR/Integration/MailganerIntegration.php"

rewrite_full_names "$FULL_DIR/EventSubscriber/CallbackSubscriber.php"
rewrite_full_names "$FULL_DIR/Model/DncFeedback.php"
perl -0777 -i -pe 's/MauticPlugin\\MailganerCallbackBundle/MauticPlugin\\MailganerBundle/g' "$FULL_DIR/Model/SharedSettings.php"
rewrite_full_names "$FULL_DIR/EventSubscriber/SettingsLifecycleSubscriber.php"
...
rewrite_full_names "$FULL_DIR/Translations/ru/messages.ini"
