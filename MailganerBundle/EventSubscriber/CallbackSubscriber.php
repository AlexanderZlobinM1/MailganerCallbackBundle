...
namespace MauticPlugin\MailganerBundle\EventSubscriber;
...
use MauticPlugin\MailganerBundle\MailganerBundle;
...
class CallbackSubscriber implements EventSubscriberInterface
{
    ...
    public function __construct(
        ...
        private ?\MauticPlugin\MailganerBundle\Model\DncFeedback $feedback = null,
    ) {
    }
    ...
    public function processCallbackRequest(TransportWebhookEvent $event): void
    {
        ...
        try {
            ...
            $event->setResponse(new Response(sprintf('Mailganer processed (%d)', $processed)));
